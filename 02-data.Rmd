...
> Also, synthetic data for KARS app can be generated from the R package [{simK}](https://simk.netlify.app/). This package was developed mainly for allowing data generation to use on KARS simulations.   
