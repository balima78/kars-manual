...
This users' manual describes how to use the Kidney Allocation Rules Simulator (KARS) app available from here: <https://balima.shinyapps.io/kars/>.
...
The chapter \@ref(data) describe the type of data used in the application and how the user can upload their own data. This data is not stored anywhere on our app and the responsibility for its usage is entirely to the user. 
